    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card">
          ...
          <form action="<?= site_url('/register_restaurant') ?>" method="post" enctype="multipart/form-data"
            ...
            <div class="mb-3">
              ...
              <input id="phone_number" type="tel" name="phone_number" class="form-control" required
                placeholder="Phone Number">
              <input type="hidden" name="country_code" id="country_code" required>
              <small id="phoneHelp" class="form-text text-danger" style="display:none;">Phone number must be 10 to 15
                digits.</small>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <small id="passwordHelp" class="form-text text-danger" style="display:none;">Password must be at least 6
                characters, with one number and one special character.</small>
            </div>
