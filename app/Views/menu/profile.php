    ...
    <form method="post" action="/menu/updateProfile" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="restaurant_name" id="restaurant_name" class="form-control"
          value="<?= isset($restaurant['restaurant_name']) ? $restaurant['restaurant_name'] : '' ?>" required
      ...
      <div class="mb-3">
        ...
        <input type="email" name="email" id="email" class="form-control"
          value="<?= isset($restaurant['email']) ? $restaurant['email'] : '' ?>" required>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="phone_number" id="phone_number" class="form-control"
          value="<?= isset($restaurant['phone_number']) ? $restaurant['phone_number'] : '' ?>" required minlength="10"
          pattern="\d+">
      </div>
